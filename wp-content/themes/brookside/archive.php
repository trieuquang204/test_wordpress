...
$sidebar = get_theme_mod('brookside_sidebar_pos_archive', 'sidebar-right');
if($sidebar != 'none'){
...
<div id="page-wrap-blog" class="container">
	<div id="content" class="<?php echo esc_attr($sidebar_pos); ?>">
		<?php if( !get_theme_mod('brookside_archive_show_title', false) ){ ?>
		...
		<div class="row">
			...
			$columns = get_theme_mod( 'brookside_archive_columns', 'span6');
	      	$display_categories = true;
	      	$display_date = get_theme_mod( 'brookside_display_post_date_archive', true);
	      	$display_comments = get_theme_mod( 'brookside_display_post_comments_archive', false);
	      	$excerpt_count = get_theme_mod( 'brookside_archive_excerpt_count', '15' );
	      	if( function_exists('BrooksideGetPostViews')){
	      		$display_views = get_theme_mod( 'brookside_display_post_views_archive', false);
	      	} else {
	      		$display_views = false;
	      	}
	      	if( function_exists('getPostLikeLink') ){
	      		$display_likes = get_theme_mod( 'brookside_display_post_likes_archive', false);
	      	} else {
	      		$display_likes = false;
	      	}
	      	if( function_exists('brookside_calculate_reading_time') ){
	      		$display_read_time = get_theme_mod( 'brookside_display_post_read_time_archive', false);
	      	} else {
	      		$display_read_time = false;
	      	}
	      	$pagination = get_theme_mod( 'brookside_display_post_pagination_archive', 'standard');
	      	$display_readmore = 'true';
	      	$ignore_featured = $ignore_sticky_posts = true;
	      	$text_align = 'textleft';
			$out = '';
			$post_style = get_theme_mod('brookside_archive_style', 'style_4');
			$thumbsize = get_theme_mod('brookside_archive_thumbnail_size','brookside-extra-medium');
			$i = 0;
			$j = 0;
			$blockclass = 'odd';
