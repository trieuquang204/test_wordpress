...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		/**
		 * Get name of default pbrooksidery column
		 *
		 ...
		 * @return string
		 */
		protected function get_default_pbrooksidery_column_name() {
			return 'plugin';
		}

		/**
		 * Get the name of the pbrooksidery column.
		 *
		 * @since 2.5.0 / WP 4.3+ compatibility
		 * @access protected
		 *
		 * @return string The name of the pbrooksidery column.
		 */
		protected function get_pbrooksidery_column_name() {
			if ( method_exists( 'WP_List_Table', 'get_pbrooksidery_column_name' ) ) {
				return parent::get_pbrooksidery_column_name();
			} else {
				return $this->get_default_pbrooksidery_column_name();
			}
		}
		...
		public function prepare_items() {
			...
			$pbrooksidery               = $this->get_pbrooksidery_column_name(); // Column which has the row actions.
			$this->_column_headers = array( $columns, $hidden, $sortable, $pbrooksidery ); // Get all necessary column headers.
