...
<header id="header" class="header7 <?php echo brookside_get_header_style(); ?> header1 clearfix">
	<?php if( get_theme_mod('brookside_header_search_button', false) ) { get_template_part('templates/headers/header', 'search'); } ?>
	<div class="header-top">
		<div class="header-top-inner <?php echo get_theme_mod('brookside_header_grid','container header-fullwidth'); ?>">
