<div id="header-main" class="<?php if( get_theme_mod('brookside_fixed_header', true) ) echo 'fixed_header'; ?>">
	<header id="header" class="header4 <?php echo brookside_get_header_style(); ?> clearfix">
		<?php if( get_theme_mod('brookside_header_search_button', false) ) { get_template_part('templates/headers/header', 'search'); } ?>
		<div class="<?php echo get_theme_mod('brookside_header_grid','container header-fullwidth'); ?>">
				<div class="span12">
					<h1 class="logo">
						...
						<?php } else { ?>
							<a href="<?php echo esc_url(home_url('/')); ?>" class="logo_text"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></a>
						<?php } ?>
					</h1>
					<div  id="navigation-block">
						...
						<?php }
							if( get_theme_mod('brookside_header_search_button', false) ) { ?>
					...
					<div class="social-icons-block">
							...
							<?php
								if( get_theme_mod('brookside_subscribe_enable', false) ){
									echo '<div class="subscribe-button-block"><a href="#" class="button button-subscribe">'.esc_html__('Subscribe', 'brookside').'</a></div>';
								}
							?>
